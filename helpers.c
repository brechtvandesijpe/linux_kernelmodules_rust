...
int rust_helper_pgd_none_or_clear_bad(pgd_t *pgd) {
	return pgd_none_or_clear_bad(pgd);
}
EXPORT_SYMBOL_GPL(rust_helper_pgd_none_or_clear_bad);

p4d_t *rust_helper_p4d_offset(pgd_t *pgdp, unsigned long address) {
	return p4d_offset(pgdp, address);
}
EXPORT_SYMBOL_GPL(rust_helper_p4d_offset);


pgd_t *rust_helper_pgd_offset_pgd(pgd_t *pgd, unsigned long address) {
	return pgd_offset_pgd(pgd, address);
};

EXPORT_SYMBOL_GPL(rust_helper_pgd_offset_pgd);
...
int rust_helper_pgd_none(pgd_t pgd) {
    return pgd_none(pgd);
};
EXPORT_SYMBOL_GPL(rust_helper_pgd_none);

int rust_helper_pgd_bad(pgd_t pgd) {
    return pgd_bad(pgd);
};
EXPORT_SYMBOL_GPL(rust_helper_pgd_bad);

int rust_helper_p4d_none(p4d_t p4d) {
    return p4d_none(p4d);
}
EXPORT_SYMBOL_GPL(rust_helper_p4d_none);

int rust_helper_p4d_bad(p4d_t p4d) {
    return p4d_bad(p4d);
}
EXPORT_SYMBOL_GPL(rust_helper_p4d_bad);

pud_t *rust_helper_pud_offset(p4d_t *p4dp, unsigned long address){   
    return pud_offset(p4dp, address);
}
EXPORT_SYMBOL_GPL(rust_helper_pud_offset);

int rust_helper_pud_bad(pud_t pud) {
    return pud_bad(pud);
}
EXPORT_SYMBOL_GPL(rust_helper_pud_bad);

int rust_helper_pud_none(pud_t pud) {
    return pud_none(pud);
}
EXPORT_SYMBOL_GPL(rust_helper_pud_none);

pmd_t *rust_helper_pmd_offset(pud_t *pudp, unsigned long address) {
    return pmd_offset(pudp, address);
}
EXPORT_SYMBOL_GPL(rust_helper_pmd_offset);

int rust_helper_pmd_none(pmd_t pmd) {
    return pmd_none(pmd);
}
EXPORT_SYMBOL_GPL(rust_helper_pmd_none);


pte_t *rust_helper_pte_offset_kernel(pmd_t *pmd, unsigned long address) {
    return pte_offset_kernel(pmd, address);
}
EXPORT_SYMBOL_GPL(rust_helper_pte_offset_kernel);

int rust_helper_pmd_large(pmd_t pmd) {
    return pmd_large(pmd);
}
EXPORT_SYMBOL_GPL(rust_helper_pmd_large);

int rust_helper_pud_large(pud_t pud) {
    return pud_large(pud);
}
EXPORT_SYMBOL_GPL(rust_helper_pud_large);


void rust_helper_native_set_pgd(pgd_t *pgdp, pgd_t pgd) {
    return native_set_pgd(pgdp, pgd);
}
EXPORT_SYMBOL_GPL(rust_helper_native_set_pgd);


pgd_t rust_helper_native_make_pgd(pgdval_t val) {
    return native_make_pgd(val);
}
EXPORT_SYMBOL_GPL(rust_helper_native_make_pgd);

void rust_helper_native_set_p4d(p4d_t *p4dp, p4d_t p4d) {
    return native_set_p4d(p4dp, p4d);
}
EXPORT_SYMBOL_GPL(rust_helper_native_set_p4d);


p4d_t rust_helper_native_make_p4d(pudval_t val) {
    return native_make_p4d(val);
}
EXPORT_SYMBOL_GPL(rust_helper_native_make_p4d);

void rust_helper_native_set_pud(pud_t *pudp, pud_t pud) {
    return native_set_pud(pudp, pud);
}
EXPORT_SYMBOL_GPL(rust_helper_native_set_pud);


pud_t rust_helper_native_make_pud(pmdval_t val) {
    return native_make_pud(val);
}
EXPORT_SYMBOL_GPL(rust_helper_native_make_pud);

void rust_helper_native_set_pmd(pmd_t *pmdp, pmd_t pmd) {
    return native_set_pmd(pmdp, pmd);
}
EXPORT_SYMBOL_GPL(rust_helper_native_set_pmd);


pmd_t rust_helper_native_make_pmd(pmdval_t val) {
    return native_make_pmd(val);
}
EXPORT_SYMBOL_GPL(rust_helper_native_make_pmd);

void rust_helper_native_set_pte(pte_t *ptep , pte_t pte) {
    return native_set_pte(ptep, pte);
}
EXPORT_SYMBOL_GPL(rust_helper_native_set_pte);


pte_t rust_helper_native_make_pte(pteval_t val) {
    return native_make_pte(val);
}
EXPORT_SYMBOL_GPL(rust_helper_native_make_pte);
